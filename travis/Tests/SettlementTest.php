...
class SettlementTest extends PHPUnit_Framework_TestCase {
	...
	public function testDriversMath() {
		...
		$this->assertEquals( $totals[ 'subtotal' ], 9.96 );
		$this->assertEquals( $totals[ 'tax' ], 0.75 );
		$this->assertEquals( $totals[ 'delivery_fee' ], 2 );
		$this->assertEquals( $totals[ 'tip' ], 2.25 );
		$this->assertEquals( $totals[ 'customer_fee' ], 0 );
		$this->assertEquals( $totals[ 'markup' ], -0 );
		$this->assertEquals( $totals[ 'credit_charge' ], 0 );
		$this->assertEquals( $totals[ 'restaurant_fee' ], 0 );
		$this->assertEquals( $totals[ 'gift_card' ], 0 );
		$this->assertEquals( $totals[ 'orders' ], 1 );
		$this->assertEquals( $totals[ 'total_reimburse' ], 10.71 );
		$this->assertEquals( $totals[ 'total_payment' ], 4.25 );
