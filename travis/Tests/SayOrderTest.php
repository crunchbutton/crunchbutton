...
$data = file_get_contents('http://localhost:8888/api/order/1/say');
...
$data = file_get_contents('http://localhost:8888/api/order/1/sayorder');
...
$data = file_get_contents('http://localhost:8888/api/order/1/sayorderonly');
...
$data = file_get_contents('http://localhost:8888/api/order/1/doconfirm');
