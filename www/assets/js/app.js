	...
	App.cache('Restaurant', id, function() {
		...
		$('.main-content').html(
			...
			'<div class="main-content-readable">' + 
				...
				'<div class="cart-items"><div class="restaurant-item-title text-your-order">Your Order</div><div class="divider"></div><div class="delivery-minimum-error">Please add more items to your order to meet the delivery minimum of $' + parseFloat(App.restaurant.delivery_min).toFixed(2) + '.</div><div class="cart-items-content"></div></div>' + 
