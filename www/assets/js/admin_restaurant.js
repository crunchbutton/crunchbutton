...
var ADMIN = {
	...
	create_widgets : function() {
		...
		w = UTIL.create_widget('toggle', $('#restaurant-show-when-closed-container'), {text : ['yes', 'no'],field_name:'show_when_closed'});
	...
	map : {
		...
		data : { // map html elements to js restaurant object data parts
			text : {
				...
				'select#restaurant-delivery_radius_type' : ['delivery_radius_type'],
