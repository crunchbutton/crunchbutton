...
/*!50003 CREATE */ /*!50017 DEFINER=`crunchapple`@`%` */ /*!50003 TRIGGER `order_uuid` BEFORE INSERT ON `order` FOR EACH ROW SET NEW.uuid =  REPLACE(UUID(),'-','') */;;
DELIMITER ;
...
DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`crunchapple`@`%` */ /*!50003 TRIGGER `user_uuid` BEFORE INSERT ON `user` FOR EACH ROW SET NEW.uuid =  REPLACE(UUID(),'-','') */;;
DELIMITER ;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE */;
