...
class Controller_Support_Plus extends Crunchbutton_Controller_Account {
	...
	public function init() {
		...
		switch ($action) {
			...
			case 'new':
				...
				header('Location: /support/plus/'.$support->id_support);
				exit;
				break;
			...
			default:
				...
				switch ($action) {
					...
					case 'checkconvo' :
						...
						if ($notes) {
							foreach ($notes as $note) {
								c::view()->display('support/plus/conversation.note', ['set' => ['note' => $note]]);
							}
						}
						exit;
						break;
					...
					case 'history':
						...
						c::view()->display( 'support/plus/history' );
						exit;
						break;
					...
					default:
						...
						if ( $support->id_support ) {
							...
							c::view()->support = $support;
							c::view()->display('support/plus/support');	
						} else {
							c::view()->display('support/plus/index');
						}
