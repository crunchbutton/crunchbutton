...
class Bootstrap
{
    ...
    {
        spl_autoload_register(array('\Querypath\Bootstrap', 'autoload'));
    ...
    {
        spl_autoload_register(array('\Querypath\Bootstrap', 'pharAutoload'));
        self::initializeResources();
    }
    
    public static function pharAutoload($classname)
    {
        self::_autoload('phar://querypath.phar', $classname);
    }
...
function qp($document = NULL, $string = NULL, $options = array()) {
  return \QueryPath\QP::with($document, $string, $options);
}
...
function htmlqp($document = NULL, $selector = NULL, $options = array()) {
  return \QueryPath\QP::withHTML($document, $selector, $options);
}
}
