...
class Bootstrap
{
    ...
    {
        spl_autoload_register(array('\Github\Bootstrap', 'autoload'));
    }
    ...
    {
        spl_autoload_register(array('\Github\Bootstrap', 'pharAutoload'));
    }
    ...
    {
        self::_autoload('phar://Github.phar', $classname);
    }
