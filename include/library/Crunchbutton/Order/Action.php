...
class Crunchbutton_Order_Action extends Cana_Table {
	...
	const TICKET_DO_NOT_DELIVERY = 'ticket-do-not-delivery';
	...
	public static function byOrder( $id_order ){
		...
		', [$id_order, self::TICKET_NOT_GEOMATCHED, self::TICKET_CAMPUS_CASH, self::TICKET_CAMPUS_CASH_REMINDER, self::TICKET_REPS_FAILED_PICKUP, self::TICKET_DO_NOT_DELIVERY]);
	}
